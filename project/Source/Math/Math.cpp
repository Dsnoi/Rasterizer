...
//
//======================================================================================================
Vector2& Vector_Normalize3(Vector2& Result, const Vector2& Input)
{
	const fp32 Length = 1.0f / Vector_Length(Input);
	Result.x = Input.x * Length;
	Result.y = Input.y * Length;
...
//
//======================================================================================================
Vector2& Vector_NormalizeSafe3(Vector2& Result, const Vector2& Input)
{
	const fp32 Length = 1.0f / Vector_Length(Input);
	if (Length > FLT_EPSILON)
	{
...
Vector3 operator ^(const Vector3 &lhs, const Vector3 &rhs) { Vector3 Result;  Vector_Set(Result, lhs.y * rhs.z - lhs.z * rhs.y, lhs.z*rhs.x - lhs.x * rhs.z, lhs.x*rhs.y - lhs.y * rhs.x); return Result; }
Vector3 operator +(const Vector3 &lhs, const Vector3 &rhs) { Vector3 Result; Vector_Add(Result, lhs, rhs); return Result; }
Vector3 operator -(const Vector3 &lhs, const Vector3 &rhs) { Vector3 Result; Vector_Sub(Result, lhs, rhs); return Result; }
Vector3 operator *(const Vector3 &lhs, float f) { Vector3 Result; Vector_Mul(Result, lhs, f); return Result; }
Vector3 operator /(const Vector3 &lhs, float f) { Vector3 Result; Vector_Div(Result, lhs, f); return Result; }
//======================================================================================================
//
//======================================================================================================
...
//
//======================================================================================================
void Vector_Normalize3(Vector3& Result, const Vector3& Input)
{
	const fp32 Length = 1.0f / Vector_Length(Input);
	Result.x = Input.x * Length;
	Result.y = Input.y * Length;
...
//
//======================================================================================================
void Vector_NormalizeSafe3(Vector3& Result, const Vector3& Input)
{
	const fp32 Length = 1.0f / Vector_Length(Input);
	if (Length > FLT_EPSILON)
	{
...
{
	const fp32 Length = 1.0f / Vector_Length3(Input);
	Result.x = Input.x * Length;
	Result.y = Input.y * Length;
	Result.z = Input.z * Length;
	Result.w = 1.0;
